...
urlpatterns = [
    ...
    path("follow-up/", RecruiterFollowUpAPIView.as_view(), name="recruiter-follow-up"),
    ...
    path("portfolio/candidate-resume/", CandidateResumeDownloadAPIView.as_view(), name="candidate-resume-download"),
    ...
    path("superadmin/upload-resume/", SuperAdminUploadResumeAPIView.as_view(), name="superadmin-upload-resume"),
